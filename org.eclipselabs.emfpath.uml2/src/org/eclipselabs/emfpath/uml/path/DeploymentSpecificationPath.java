 ...
 * @generated
 */
public final class DeploymentSpecificationPath {
	 ...
	 * @generated
	 */
	public static final Function<Artifact, String> fileName = ArtifactPath.fileName;

	/**
	 * @generated
	 */
	public static final Function<Artifact, EList<Artifact>> nestedArtifact = ArtifactPath.nestedArtifact;

	/**
	 * @generated
	 */
	public static final Function<Artifact, EList<Manifestation>> manifestation = ArtifactPath.manifestation;

	/**
	 * @generated
	 */
	public static final Function<Artifact, EList<Operation>> ownedOperation = ArtifactPath.ownedOperation;

	/**
	 * @generated
	 */
	public static final Function<Artifact, EList<Property>> ownedAttribute = ArtifactPath.ownedAttribute;
	...
	public static Function<Artifact, Operation> createOwnedOperation(final String name, final EList<String> parameterNames, final EList<Type> parameterTypes, final Type returnType) {
		return ArtifactPath.createOwnedOperation(name, parameterNames, parameterTypes, returnType);
	}
	...
	public static Function<Artifact, Property> createOwnedAttribute(final String name, final Type type, final int lower, final int upper) {
		return ArtifactPath.createOwnedAttribute(name, type, lower, upper);
	}
