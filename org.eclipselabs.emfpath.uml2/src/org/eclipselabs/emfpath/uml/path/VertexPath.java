...
public final class VertexPath {
	 ...
	 * @generated
	 */
	public static final Function<Vertex, StateMachine> containingStateMachine /*false*/ = new Function<Vertex, StateMachine>() {
	 ...
	 * @generated
	 */
	public static final Function<Vertex, EList<Transition>> getOutgoings /*false*/ = new Function<Vertex, EList<Transition>>() {
		public EList<Transition> apply(Vertex s) {
			return s.getOutgoings();
		}
	};
	 ...
	 * @generated
	 */
	public static final Function<Vertex, EList<Transition>> getIncomings /*false*/ = new Function<Vertex, EList<Transition>>() {
		public EList<Transition> apply(Vertex s) {
			return s.getIncomings();
		}
	};
