package org.eclipselabs.emfpath.trans.engine.muxdemux.blocking;
...
import org.eclipselabs.emfpath.trans.engine.internal.BlockingIterable;
import org.eclipselabs.emfpath.trans.engine.internal.BlockingIterables;
...
public class QueuedMultiplexer implements IMultiplexer {
	...
	public <E extends ITransformationRule> ImmutableMap<E, BlockingIterable<Map<String, EObject>>> multiplex(ITransformationEngineInput inputs, ImmutableList<? extends E> rules) {
	...
	private static ImmutableMap<String, Iterator<? extends EObject>> buildInputIteratorsMap(ITransformationEngineInput inputs) {
