...
public class AddVariableValueActionPath extends WriteVariableActionPath {
	 ...
	 * @generated
	 */
	public static final ComposablePredicate<AddVariableValueAction> isReplaceAll = new ComposablePredicate<AddVariableValueAction>() {
	 ...
	 * @generated
	 */
	public static ComposablePredicate<AddVariableValueAction> validateSingleInputPin(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
    return new ComposablePredicate<AddVariableValueAction>() {
      public boolean apply(AddVariableValueAction s) {
