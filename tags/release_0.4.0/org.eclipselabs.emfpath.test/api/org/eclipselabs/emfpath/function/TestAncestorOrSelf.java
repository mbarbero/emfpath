 ...
 *
 */
public class TestAncestorOrSelf extends AbstractTestNavigation {
	...
	public void testOf() {
		...
		List<String> expected = Lists.newArrayList("n1", "root", "myTree");
		Iterable<String> actual = Iterables.transform(ancestorOrSelf.of(node),
	...
	public void testOf2() {
		...
		List<String> expected = Lists.newArrayList("n223", "n22", "n2", "root",
		"myTree");
		Iterable<String> actual = Iterables.transform(ancestorOrSelf.of(node),
			EGet.<String> feature("name"));
	...
	public void testOf3() {
		...
		assertTrue(Iterables.elementsEqual(Lists.newArrayList(theTree),
			ancestorOrSelf.of(theTree)));
	}
}
