 ...
 * @generated
 */
public final class DeploymentTargetPath {

	/**
	 * @generated
	 */
	private DeploymentTargetPath() {
	 ...
	 * @generated
	 */
	public static final Function<DeploymentTarget, EList<PackageableElement>> getDeployedElements /*false*/ = new Function<DeploymentTarget, EList<PackageableElement>>() {
		public EList<PackageableElement> apply(DeploymentTarget s) {
			return s.getDeployedElements();
		}
	};
