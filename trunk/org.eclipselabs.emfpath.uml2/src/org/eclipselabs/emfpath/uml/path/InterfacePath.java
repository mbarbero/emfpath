...
public final class InterfacePath {
	 ...
	 * @generated
	 */
	public static Function<Interface, Operation> createOwnedOperation /*false*/(final String name, final EList<String> parameterNames, final EList<Type> parameterTypes, final Type returnType) {
	 ...
	 * @generated
	 */
	public static Function<Interface, Property> createOwnedAttribute /*false*/(final String name, final Type type, final int lower, final int upper) {
