...
public final class MessagePath {
	 ...
	 * @generated
	 */
	public static final Function<Message, MessageKind> getMessageKind /*false*/ = new Function<Message, MessageKind>() {
		public MessageKind apply(Message s) {
			return s.getMessageKind();
		}
	};
	 ...
	 * @generated
	 */
	public static final Function<Message, NamedElement> getSignature /*false*/ = new Function<Message, NamedElement>() {
		public NamedElement apply(Message s) {
			return s.getSignature();
		}
	};
