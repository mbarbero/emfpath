 ...
 *
 */
public class TestDescendantOrSelf extends AbstractTestNavigation {
	...
	public void testOf() {
		...
		List<String> expected = Lists.newArrayList("n1", "n11", "n111", "n112",
			"n113", "n12", "n121", "n122", "n123", "n13", "n131", "n132",
		"n133");
		Iterable<String> actual = Iterables.transform(descendantOrSelf.of(node), EGet
			.<String> feature("name"));
	...
	public void testOf2() {
		...
		List<String> expected = Lists.newArrayList("n223");
		Iterable<String> actual = Iterables.transform(descendantOrSelf.of(node), EGet
			.<String> feature("name"));
	...
	public void testOf3() {
		...
		List<String> expected = Lists.newArrayList("myTree", "root", "n1", "n11", "n111",
		...
		Iterable<String> actual = Iterables.transform(descendantOrSelf.of(theTree),
