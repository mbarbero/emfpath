...
public class NodePath extends ClassPath {
	 ...
	 * @generated
	 */
	public static ComposablePredicate<Node> validateInternalStructure(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
    return new ComposablePredicate<Node>() {
